...
def generate_launch_description():
    ...
    node_name = 'ouster_driver_rl'
    config_name = 'ouster_rl_config.yaml'
    ...
    driver_node = LifecycleNode(package='ros2_ouster',
                                ...
                                remappings=[('scan', 'rear_left/scan')],
                                remappings=[('range_image', 'rear_left/range_image')],
                                remappings=[('intensity_image', 'irear_left/ntensity_image')],
                                remappings=[('noise_image', 'rear_left/noise_image')],
                                remappings=[('reflectivity_image', 'rear_left/reflectivity_image')],
                                remappings=[('points', 'rear_left/points')],
                                remappings=[('imu', 'rear_left/imu')],
