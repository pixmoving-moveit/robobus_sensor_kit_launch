...
def generate_launch_description():
    ...
    node_name = 'ouster_driver_fr'
    config_name = 'ouster_fr_config.yaml'
    ...
    driver_node = LifecycleNode(package='ros2_ouster',
                                ...
                                remappings=[('scan', 'front_right/scan')],
                                remappings=[('range_image', 'front_right/range_image')],
                                remappings=[('intensity_image', 'front_right/intensity_image')],
                                remappings=[('noise_image', 'front_right/noise_image')],
                                remappings=[('reflectivity_image', 'front_right/reflectivity_image')],
                                remappings=[('points', 'front_right/points')],
                                remappings=[('imu', 'front_right/imu')],
