...
def generate_launch_description():
    ...
    default_params_file = \
        Path(ouster_ros_pkg_dir) / 'config' / 'os_rr_config.yaml'
    ...
    sensor_configure_cmd = invoke_lifecycle_cmd('sensing/lidar/rear_right/ouster/os_sensor', 'configure')
    sensor_activate_cmd = invoke_lifecycle_cmd('sensing/lidar/rear_right/ouster/os_sensor', 'activate')
