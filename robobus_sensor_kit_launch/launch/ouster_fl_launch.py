...
def generate_launch_description():
    ...
    node_name = 'ouster_driver_fl'
    config_name = 'ouster_fl_config.yaml'
    ...
    driver_node = LifecycleNode(package='ros2_ouster',
                                ...
                                remappings=[('scan', 'front_left/scan')],
                                remappings=[('range_image', 'front_left/range_image')],
                                remappings=[('intensity_image', 'front_left/intensity_image')],
                                remappings=[('noise_image', 'front_left/noise_image')],
                                remappings=[('reflectivity_image', 'front_left/reflectivity_image')],
                                remappings=[('points', 'front_left/points')],
                                remappings=[('imu', 'front_left/imu')],
