...
def generate_launch_description():
    driver_dir = os.path.join(get_package_share_directory('robobus_sensor_kit_launch'), 'config', 'lslidar_ch128x1.yaml')
    rviz_dir = os.path.join(get_package_share_directory('lslidar_driver'), 'rviz_cfg', 'lslidar_ch128x1.rviz')
